...
#define WIN_CHECK_LEAKS
	...
	try {
		...
		case FInitResultHelp: {
			...
			cout <<
			     "Usage: Fritzing [-f FOLDER] [-pp FOLDER] [OPTION]... [FILE]\n"
			     "\n"
			     ...
			     "  -drc                          with -i, run a design rule check on the sketch file???\n"
			     ...
			     "  -i, -inscription FILE         InscriptionService panel FILE???\n"
			     ...
			     "  -nm                           with -i, disable messages???\n"
			     "  -ov, -overridefolder FOLDER   PaletteModel::setFzpOverrideFolder???\n"
			     "  -p, -panel FILE               m_panelFilename???\n"
			     "  -pc FILE                      m_panelizerCustom panel FILE???\n"
			     "  -pp, -parts FOLDER            use Fritzing parts in folders under FOLDER\n"
			     ...
			     "  -v, -version                  print Fritzing version\n"
			     "\n"
