...
ConsoleSettings::Settings ConsoleSettings::settings() const
{
	return currentSettings;
}

void ConsoleSettings::showPortInfo(int idx)
{
	if (idx != -1) {
...
void ConsoleSettings::apply()
{
	updateSettings();
	hide();
}

void ConsoleSettings::checkCustomBaudRatePolicy(int idx)
{
...
void ConsoleSettings::fillPortsParameters()
{
