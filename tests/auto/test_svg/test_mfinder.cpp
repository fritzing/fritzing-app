...
BOOST_AUTO_TEST_CASE( mfinder )
{
	...
	input1.trimmed().indexOf(MFinder, 0, &match);
	...
	input2.trimmed().indexOf(MFinder, 0, &match2);
	priorM = match2.captured(1) + match2.captured(2) + "," + match2.captured(3) + " ";
	...
	input3.trimmed().indexOf(MFinder, 0, &match3);
	priorM = match3.captured(1) + match3.captured(2) + "," + match3.captured(3) + " ";
